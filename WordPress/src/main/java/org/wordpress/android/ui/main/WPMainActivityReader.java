 ...
 */
public class WPMainActivityReader extends AppCompatActivity implements Bucket.Listener<Note> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            actionBar.setTitle(R.string.reader);
            ...
            public void onMenuTabSelected(@IdRes int menuItemId) {
                ...
                switch (menuItemId) {
                    case R.id.bottomBarItemSites:
                        ActivityLauncher.viewSites(WPMainActivityReader.this);
                        break;
                    case R.id.bottomBarItemReader:
                        ActivityLauncher.viewReader(WPMainActivityReader.this);
                        break;
                    case R.id.bottomBarItemMe:
                        ActivityLauncher.viewMe(WPMainActivityReader.this);
                        break;
                    case R.id.bottomBarItemNotifications:
                        ActivityLauncher.viewNotifications(WPMainActivityReader.this);
                        break;
                }
            }
...
//                }
        ...
        new Handler().post(new Runnable() {
            @Override
            public void run() {
                mTabLayout.setSelectedTabPosition(1);
            }
        });
