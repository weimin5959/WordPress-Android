...
public class LoginEmailWpcomFragment extends AbstractFragment implements TextWatcher {
    private static String ARG_SITE_ADDRESS = "siteAddress";

    public static final String TAG = "login_email_wpcom_fragment_tag";
    ...
    protected View mDontHaveWpcomAccountButton;

    protected @Inject SiteStore mSiteStore;
    protected @Inject AccountStore mAccountStore;
    protected @Inject Dispatcher mDispatcher;

    public interface OnEmailWpcomInteraction {
        void onMagicLinkEmailCheckSuccess(String email);
        void onNoWpcomAccount(String siteAddress);
    }
    private OnEmailWpcomInteraction mListener;

    public String getEmail() {
        return mEmail;
    }

    public static LoginEmailWpcomFragment newInstance(String siteAddress) {
        LoginEmailWpcomFragment lewf = new LoginEmailWpcomFragment();
        Bundle bundle = new Bundle();
        bundle.putString(ARG_SITE_ADDRESS, siteAddress);

        lewf.setArguments(bundle);
        return lewf;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.login_email_wpcom_screen, container, false);
        ...
        mDontHaveWpcomAccountButton = rootView.findViewById(R.id.login_no_wpcom_account);
        ...
        mDontHaveWpcomAccountButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.onNoWpcomAccount(mSiteAddress);
            }
        });
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnEmailWpcomInteraction) {
            mListener = (OnEmailWpcomInteraction) context;
        } else {
            throw new RuntimeException(context.toString() + " must implement OnEmailWpcomInteraction");
        }
    }
