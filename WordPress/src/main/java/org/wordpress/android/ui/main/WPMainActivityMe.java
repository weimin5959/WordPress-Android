 ...
 */
public class WPMainActivityMe extends AppCompatActivity implements Bucket.Listener<Note> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            actionBar.setTitle(R.string.tabbar_accessibility_label_me);
            ...
            public void onMenuTabSelected(@IdRes int menuItemId) {
                ...
                switch (menuItemId) {
                    case R.id.bottomBarItemSites:
                        ActivityLauncher.viewSites(WPMainActivityMe.this);
                        break;
                    case R.id.bottomBarItemReader:
                        ActivityLauncher.viewReader(WPMainActivityMe.this);
                        break;
                    case R.id.bottomBarItemMe:
                        ActivityLauncher.viewMe(WPMainActivityMe.this);
                        break;
                    case R.id.bottomBarItemNotifications:
                        ActivityLauncher.viewNotifications(WPMainActivityMe.this);
                        break;
                }
            }
...
//                }
        ...
        new Handler().post(new Runnable() {
            @Override
            public void run() {
                mTabLayout.setSelectedTabPosition(2);
            }
        });
